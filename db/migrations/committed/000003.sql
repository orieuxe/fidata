--! Previous: sha1:34ed70f1ec65c6b18fe5e3f1e216f88587a198b7
--! Hash: sha1:8230358304133d7c9753772972b6020af936be47

-- Enter migration here

-- Player detail page year-by-year breakdown: games played and rating delta
-- per cadence, one row per year. Exposed at /rpc/player_yearly_stats.
create or replace function player_yearly_stats(p_fideid integer)
returns table (
    year            integer,
    games_standard  bigint,
    delta_standard  integer,
    games_rapid     bigint,
    delta_rapid     integer,
    games_blitz     bigint,
    delta_blitz     integer,
